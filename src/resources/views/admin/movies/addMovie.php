...
<form action="/admin-panel/movies/add" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['original_title']) ? 'is-invalid' : '' ?>" id="original_title" name="original_title"  value="<?= htmlspecialchars($old['original_title'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['title']) ? 'is-invalid' : '' ?>" id="title" name="title"  value="<?= htmlspecialchars($old['title'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control <?= isset($errors['overview']) ? 'is-invalid' : '' ?>" id="overview" name="overview" rows="3" ><?= htmlspecialchars($old['overview'] ?? '') ?></textarea>
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control <?= isset($errors['release_date']) ? 'is-invalid' : '' ?>" id="release_date" name="release_date" value="<?= htmlspecialchars($old['release_date'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.1" class="form-control <?= isset($errors['vote_average']) ? 'is-invalid' : '' ?>" id="vote_average" name="vote_average" value="<?= htmlspecialchars($old['vote_average'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control <?= isset($errors['vote_count']) ? 'is-invalid' : '' ?>" id="vote_count" name="vote_count" value="<?= htmlspecialchars($old['vote_count'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.1" class="form-control <?= isset($errors['popularity']) ? 'is-invalid' : '' ?>" id="popularity" name="popularity"  value="<?= htmlspecialchars($old['popularity'] ?? '') ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['original_language']) ? 'is-invalid' : '' ?>" id="original_language" name="original_language"  value="<?= htmlspecialchars($old['original_language'] ?? '') ?>">
